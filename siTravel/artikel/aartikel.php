...
<tr><td colspan='2'>
      ...
      [ <a href="utama.php?page2=isiartikel&&id=<?php echo "$c[id]"; ?>"><i>read more</a> ]</i></p><br></td>
				...
				<?php
					...
					<a href='?page2=aartikel&page=$sebelum' class='navigasi' title='Sebelumnya'> Prev&nbsp;</a>";
					for ($i=1; $i <= $jumlah_hal; $i++)
					{
						echo " <a href='?page2=aartikel&page=$i' class='numpage'>&nbsp; $i &nbsp;</a> ";
					}
					echo "<a href='?page2=aartikel&page=$lanjut' class='navigasi' title='Selanjutnya'>&nbsp; Next</a></center>
					</td>
						</tr>
							</table>";
				?>
