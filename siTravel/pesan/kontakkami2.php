	...
	$pesan = $_POST['pesan'];
		...
		$masuk = mysql_query("insert into contactus(subjek,email,pesan,tgl) 
				...
				if($masuk){ echo " <script> alert ('Pesan Berhasil Dikirim'); 
					window.location ='index.php?page2=intro'</script>"; 
						}
...
<?php 
	...
	<tr>
		<td><br><br></td><td width='7%'><img src='admin/photo/mail.png' width='23px' height='23px'></td><td> : </td><td></td><td>aubellfoodcontainer@gmail.com</td>
	</tr>
	<tr>
