      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo site_url('petugas/insert_bayar_tagihan') ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input disabled="" type="text" name="bulan" value="<?php $cek = $this->petugas_model->data_bulan_by_id($tagihan->BULAN); echo $cek->NAMA?>" class="form-control" >
                </div>
                <div class="form-group">
