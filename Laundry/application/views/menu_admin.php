...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-lg"><b>Pembayaran</b>Laundry</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo site_url('admin/data_tarif')?>">
            <i class="fa fa-edit"></i> <span>Tarif</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('admin/data_pelanggan')?>">
            <i class="fa fa-users"></i> <span>Data Pelanggan</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('admin/data_petugas')?>">
            <i class="fa fa-male"></i> <span>Data Petugas</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('admin/filter_laporan')?>">
