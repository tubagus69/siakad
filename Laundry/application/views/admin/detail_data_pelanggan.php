...
<form method="post" action="<?php echo site_url('admin/edit_pelanggan') ?>">
 ...
 -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Detail Data Pelanggan</li>
      </ol>
    </section>
            ...
            <form method="post" action="<?php echo site_url('admin/edit_pelanggan') ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input readonly="" type="text" name="nometer" value="<?php echo $data->NOMETER; ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Nama</label>
                ...
                <div class="form-group">
                  ...
                  <input readonly="" type="text" name="alamat" value="<?php echo $data->PASSWORD ?>" class="form-control">
                </div>
                <!-- <div class="form-group">
