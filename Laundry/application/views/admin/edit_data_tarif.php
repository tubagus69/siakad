            ...
            <form method="post" action="<?php echo site_url('admin/edit_tarif') ?>">
              <div class="box-body">
                <div class="form-group">
                  <input type="hidden" name="kode" value="<?php echo $data->KODETARIF; ?>">
                  <label>DAYA</label>
                  <input type="text" name="daya" value="<?php echo $data->DAYA; ?>" class="form-control">
                </div>
                <div class="form-group">
                  <label>Tarif per Kwh</label>
                  <input type="text" name="tarif" value="<?php echo $data->TARIFPERKWH; ?>" class="form-control">
                </div>
              </div>
              <!-- /.box-body -->
