            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        ...
                        <p>Manajemen Informatika class 2B</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-10 col-sm-16 col-lg-4">
                    <div class="single-team-member text-center mb-100">
                        ...
                        <div class="team-member-thumb">
                            <img src="<?php echo base_url().'assets/image/p_winandri.jpeg';?>" style="width:600px; height:400px;" alt="">
                            <!-- Social Info -->
                ...
                <div class="col-10 col-sm-16 col-lg-4">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="<?php echo base_url().'assets/image/p_yoga.jpeg';?>" style="width:600px; height:400px;" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
