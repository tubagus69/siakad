...
class loginsiswa extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('loginsiswa/index');
    ...
    public function proses_login()
    {
        ...
        $this->load->model('loginsiswa_model');
        $ceklogin=$this->loginsiswa_model->login($username, $password);
            if ($ceklogin){
                foreach ($ceklogin as $row);
                    ...
                    elseif ($this->session->userdata('level')=="user_siswa") {
                ...
                $data['title']='Login';
                $this->load->view('template/header_login', $data);
                $this->load->view('loginsiswa/index', $data);
                $this->load->view('template/footer');
